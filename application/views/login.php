...
<body>
        ...
        <div class="card card-container">
            ...
            <form class="form-signin" id="form1" action="<?php echo base_url();?>index.php/Home/log_usr" method="post">
            ...
            <div>
                <a title="Register" href="<?php echo base_url()?>index.php/Welcome/index">Register</a>
            </div>
