...
<body>
        ...
        <div class="card card-container">
            ...
            <form class="form-signin" id="form1" action="<?php echo base_url();?>index.php/Welcome/reg_user" method="post">
                ...
                <input type="text" id="name_last" name="display_name1" class="form-control" placeholder="Last name (Optional)" >
                ...
                <input type="password" name="pass" id="inputPassword" class="form-control" placeholder="Password (Max 15 characters)" maxlength="15" required>
                <div id="pass2_verify"></div>
                <input type="password" name="pass2" id="inputPassword2" class="form-control" placeholder="Retype password" maxlength="15" required>
                <div id="mobile"></div>
                <input type="text" id="phone" name="mobile" class="form-control" placeholder="Phone" maxlength="10"> 
                <br>
                
                <button class="btn btn-lg btn-primary btn-block btn-signin" id="click" type="submit">Sign up</button>
            </form><!-- /form -->
             <a title="Login" href="<?php echo base_url();?>index.php/Home/index">Login</a>
